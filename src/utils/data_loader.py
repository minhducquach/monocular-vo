...
def load_kitti(data_path, sequence) -> tuple[np.ndarray, np.ndarray, int]:
    """
    ...
    kitti_image_path = os.path.join(data_path, 'data_odometry_gray/dataset/sequences', sequence, 'image_0')
